...
function buildLegalFooter(o = {}) {
  ...
  const iconesHtml = redes.length
    ? `<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="right" style="border-collapse:collapse"><tr>${
        redes.map((r, i) =>
          `<td style="padding:0 0 0 ${i === 0 ? 0 : 10}px;line-height:1;font-size:0"><a href="${escHtml(r.href)}" target="_blank" style="text-decoration:none"><img src="${escHtml(r.icon)}" width="22" height="22" alt="${escHtml(r.nome)}" style="display:block;border:0;outline:none;text-decoration:none"></a></td>`
        ).join('')
      }</tr></table>`
    : '';
