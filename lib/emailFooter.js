 ...
 * @param {boolean} [o.semFraseLegal]   omite a frase legal (remetente e sede);
 *                                      os links de rodapé mantêm-se sempre
 */
function buildLegalFooter(o = {}) {
  ...
  // A frase legal pode ser desligada por campanha (ecrã de envio). A linha dos
  // links nunca é: o "Cancelar subscrição" é obrigatório em envios em volume
  // (Gmail/Yahoo desde 2024) e é o par do cabeçalho List-Unsubscribe.
  const frase = o.semFraseLegal ? '' :
  ...
  <tr><td align="center" style="padding:0">
    <table role="presentation" width="${largura}" cellpadding="0" cellspacing="0" border="0" style="max-width:${largura}px;width:100%">
      ...
      <tr><td align="center" style="padding:${frase ? '0' : '18px'} 28px 24px;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:1.2;color:#8a8a8a">${links}</td></tr>
    </table>
  </td></tr>
</table>`;
}
