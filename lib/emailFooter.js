...
function buildLegalFooter(o = {}) {
  ...
  const areaCinza = (textoDisclaimer || linhaMarca)
    ? `<tr><td style="padding:0 0 8px">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="${AREA_BG}" style="background:${AREA_BG};background-color:${AREA_BG};border-radius:10px">
