-- PrimeMail — Dados iniciais (marcas + utilizador admin)
-- Password do admin: Admin1234! (alterar após primeiro login)

INSERT IGNORE INTO brands (id, name, color, from_name, from_email) VALUES
...
-- Dar acesso owner a todas as marcas ao admin (id=1)
INSERT IGNORE INTO user_brand_roles (user_id, brand_id, role)
SELECT 1, id, 'owner' FROM brands;
